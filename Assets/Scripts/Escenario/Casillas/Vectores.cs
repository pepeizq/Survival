...
namespace Escenario.Casillas
{
    public class Vectores : MonoBehaviour
    {
        ...
        public List<Vector3> GenerarTerreno(Assets.Terreno[,] terrenos, int tamañoEscenarioX, int tamañoEscenarioZ, float alturaMaxima, int limitesMapa)
        {
            ...
            while (i <= intentosGeneracion)
            {
                ...
                foreach (Assets.Terreno casilla in terrenos)
                {
                    if (casilla != null)
                    {
        ...
        public List<Vector3> GenerarAgua(Assets.Terreno[,] terrenos, int tamañoEscenarioX, int tamañoEscenarioZ, float alturaMaxima, int limitesMapa)
        {
