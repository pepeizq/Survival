...
namespace Escenario.Generar
{
    public class Colores : MonoBehaviour
    {
        ...
        public void Casilla_Xmas1_Zmenos1(int x, float y, int z)
        {
            ...
            if (Escenario.instancia.ComprobarCasilla0(Escenario.instancia.casillas[x, z], y, 0) == true && Escenario.instancia.ComprobarCasilla2(Escenario.instancia.casillas[x + 2, z - 2], y, 270) == true)
            {
                Escenario.instancia.PonerCasilla(rampas4rotacion0);
            }
            else if (Escenario.instancia.ComprobarCasilla2(Escenario.instancia.casillas[x, z], y, 90) == true && Escenario.instancia.ComprobarCasilla2(Escenario.instancia.casillas[x + 2, z - 2], y, 270) == true)
            {
                Escenario.instancia.PonerCasilla(rampas4rotacion0);
            }
            else if (Escenario.instancia.ComprobarCasilla2(Escenario.instancia.casillas[x, z], y, 90) == true && Escenario.instancia.ComprobarCasilla0(Escenario.instancia.casillas[x + 2, z - 2], y, 0) == true)
            {
                Escenario.instancia.PonerCasilla(rampas4rotacion0);
            }
            else if (Escenario.instancia.ComprobarCasilla0(Escenario.instancia.casillas[x, z], y, 0) == true && Escenario.instancia.ComprobarCasilla2(Escenario.instancia.casillas[x + 2, z - 2], y, 270) == true)
            {
                Escenario.instancia.PonerCasilla(rampas4rotacion0);
            }
            else if (Escenario.instancia.ComprobarCasilla0(Escenario.instancia.casillas[x, z], y, 0) == true && Escenario.instancia.ComprobarCasilla0(Escenario.instancia.casillas[x + 2, z - 2], y, 0) == true)
            {
                Escenario.instancia.PonerCasilla(rampas4rotacion0);
            }
        ...
        public void Casilla_Xmas1_Zmas1(int x, float y, int z)
        {
            ...
            else if (Escenario.instancia.ComprobarCasilla0(Escenario.instancia.casillas[x, z], y, 0) == true && Escenario.instancia.ComprobarCasilla0(Escenario.instancia.casillas[x, z + 1], y, 0) == true && Escenario.instancia.ComprobarCasilla2(Escenario.instancia.casillas[x + 1, z - 1], y, 270) == true)
            {
                Escenario.instancia.PonerCasilla(esquina3rotacion0);
            }
            ...
            if (Escenario.instancia.ComprobarCasilla0(Escenario.instancia.casillas[x, z], y, 0) == true && Escenario.instancia.ComprobarCasilla2(Escenario.instancia.casillas[x + 2, z + 2], y, 180) == true)
            {
                Escenario.instancia.PonerCasilla(rampas4rotacion90);
            }
            else if (Escenario.instancia.ComprobarCasilla2(Escenario.instancia.casillas[x, z], y, 0) == true && Escenario.instancia.ComprobarCasilla2(Escenario.instancia.casillas[x + 2, z + 2], y, 180) == true)
            {
                Escenario.instancia.PonerCasilla(rampas4rotacion90);
            }
            else if (Escenario.instancia.ComprobarCasilla2(Escenario.instancia.casillas[x, z], y, 0) == true && Escenario.instancia.ComprobarCasilla0(Escenario.instancia.casillas[x + 2, z + 2], y, 0) == true)
            {
                Escenario.instancia.PonerCasilla(rampas4rotacion90);
            }
            else if (Escenario.instancia.ComprobarCasilla0(Escenario.instancia.casillas[x, z], y, 0) == true && Escenario.instancia.ComprobarCasilla0(Escenario.instancia.casillas[x + 2, z + 2], y, 0) == true)
