...
public class Jugador : MonoBehaviour
{
    ...
    private Vector2 curvaMovimientoInput;
    ...
    {
        Vector3 direccion = transform.forward * curvaMovimientoInput.y + transform.right * curvaMovimientoInput.x;
    ...
    public void MovimientoInput(InputAction.CallbackContext contexto)
    {
        ...
        {
            curvaMovimientoInput = contexto.ReadValue<Vector2>();
        }
        else if (contexto.phase == InputActionPhase.Canceled)
        {
            curvaMovimientoInput = Vector2.zero;
        }
    }
